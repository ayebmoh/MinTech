...
const Footer = () => {
  return (
    <>
      {" "}
      <div className="mt-20 bg-gradient-to-b from-sky-800 to-slate-900 py-16 px-6 font-[sans-serif]">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-5xl font-bold mb-6 text-white">
            Subscribe to Our Newsletter
          </h2>
          <p className="text-base text-gray-300">
            Stay updated with the latest news, and special offers. Don't miss
          ...
          <div className="mt-12 flex items-center overflow-hidden bg-gray-50 rounded-md max-w-xl mx-auto">
            ...
            />
            <button className="bg-sky-600 hover:bg-sky-800 text-white text-base tracking-wide py-3.5 px-6 hover:shadow-md hover:transition-transform transition-transform hover:scale-105 focus:outline-none">
              Subscribe
            </button>
          </div>
        </div>
      </div>{" "}
      <footer className="bg-gradient-to-b from-transparent to-black border-t border-gray-700 p-10 font-[sans-serif] tracking-wide">
        ...
        <p className="text-gray-300 text-center text-sm mt-10">
          © MinTech {new Date().getFullYear()}. All rights reserved.
        </p>
      </footer>
    </>
  );
